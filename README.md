...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/vedant-patil)
...
### 🚀 Applied AI · Distributed Systems · Ships Real Things

*"Building systems that run in production, not just in slides."*
...
public class Vedant extends BackendEngineer {
    ...
    String[] hobbies   = { "Competitive Programming", "Marathons", "Hackathons" };

    @Override
    public String getMotivation() {
        return "Turn messy constraints into things that actually run.";
    }
}
```
...
![Microservices](https://img.shields.io/badge/Microservices-0052CC?style=flat-square&logo=azuredevops&logoColor=white)
...
<table>
  <tr>
    <td width="50%">
      ...
      <a href="https://github.com/omkar454/CIVIC">View Repo →</a>
    </td>
    <td width="50%">
  ...
  <tr>
    <td width="50%">
      ...
      <a href="https://github.com/Patientzero0/LegalAI">View Repo →</a>
    </td>
    <td width="50%">
...
- 🧩 **300+ problems** solved across LeetCode, Codeforces & CodeChef
- 🥷 **SIH '24 & '25**, Mumbai Hacks '25, multiple college-level hackathons
- 🏃 **Marathon runner** | Former competitive **Handball & Chess** player
- 🤝 **NSS Volunteer** — 120+ hours of community service (Blood Donation, Beach Cleanups)

---

## 💼 Experience

**Software Development & Testing Intern** @ [Maha Mumbai Metro Operation Corporation Ltd (MMMOCL)](https://mahametro.org)
`Feb 2026 – Present`

→ Automated Reconciliation Dashboard unifying E-Revenue and Bank Deposit workflows
→ Stall meter reading app for real-time commercial tracking with automated data verification
